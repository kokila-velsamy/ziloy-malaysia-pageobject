...
Call log:
  - waiting for locator('#passwordlogin_password')
      ...
      - generic [ref=e27]:
        ...
        - generic [ref=e30]:
          - generic [ref=e32]:
            ...
            - generic [ref=e45]:
              - button "Login with password" [ref=e47] [cursor=pointer]
              - button "Login with OTP" [ref=e49] [cursor=pointer]
          - generic [ref=e51]:
...
```ts
  ...
  25  |         this.login_with_password_btn=page.locator('#passwordlogin_password')
